      ...
      <section className="mo-section">
        ...
        {data.experiences.map((exp, i) => (
          <div key={i} className="mo-exp">
            ...
            <Editable as="p" value={exp.exitReason || ""} onSave={(v) => save(`experiences.${i}.exitReason`, v)} className="cv-meta-line" placeholder={isFr ? "// pourquoi j'ai quitté ce poste (optionnel)" : "// why I left this role (optional)"} rich={false} />
