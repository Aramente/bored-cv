...
const styles = StyleSheet.create({
  ...
  summary: { fontSize: 11, lineHeight: 1.55, fontFamily: "Times-Italic", marginBottom: 14 },
  exp: { marginBottom: 12 },
  ...
  bullet: { fontSize: 10, color: "#334155", marginBottom: 2, paddingLeft: 10, lineHeight: 1.5 },
