          ...
          <section className="co-section">
            ...
            {data.experiences.map((exp, i) => (
              <div key={i} className="co-exp">
                ...
                <ul className="cv-bullets co-bullets">
                  {exp.bullets.map((b, j) => (
                    <li key={j} className="cv-bullet-row">
                      <Editable as="div" value={b} onSave={(v) => save(`experiences.${i}.bullets.${j}`, v)} className="cv-bullet co-bullet" placeholder={isFr ? "Réalisation avec chiffres" : "Achievement with numbers"} />
