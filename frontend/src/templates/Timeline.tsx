...
const styles = StyleSheet.create({
  ...
  summary: { borderLeftWidth: 2, padding: "4 10", marginBottom: 14, fontSize: 10, lineHeight: T.summaryLineHeight },
  ...
  exp: { marginBottom: T.expBlockMarginBottom, position: "relative" },
